  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // EcoTracker theme colors
        eco: {
          primary: "hsl(var(--eco-primary))",
          "primary-light": "hsl(var(--eco-primary-light))",
          secondary: "hsl(var(--eco-secondary))",
          purple: "hsl(var(--eco-accent-purple))",
          orange: "hsl(var(--eco-accent-orange))",
          yellow: "hsl(var(--eco-accent-yellow))",
          blue: "hsl(var(--eco-accent-blue))",
          cyan: "hsl(var(--eco-accent-cyan))",
        },
        category: {
